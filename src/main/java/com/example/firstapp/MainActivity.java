...
//test
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText xCoordOne = findViewById(R.id.x_one);
        xCoordOne.setHint("X-Koordinate 1");

        final EditText yCoordOne = findViewById(R.id.y_one);
        yCoordOne.setHint("Y-Koordinate 1");

        final EditText xCoordTwo = findViewById(R.id.x_two);
        xCoordTwo.setHint("X-Koordinate 2");

        final EditText yCoordTwo = findViewById(R.id.y_two);
        yCoordTwo.setHint("Y-Koordinate 2");

        //Create Buttons
        final Button btn = findViewById(R.id.test_button);
        final ImageButton map = findViewById(R.id.map);
        final Button getLocationOne = findViewById(R.id.first_button);
        final Button getLocationTwo = findViewById(R.id.second_button);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 1) {// Wenn Location Permission gegeben
...
//////// Api-key: 5b3ce3597851110001cf6248daf1be4a1e8b4ba1b5f3a680d51485a2